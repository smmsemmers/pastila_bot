...
PIN_MAIN_TEXT = (
    "🍬 <b>Pastila OS — операционный штаб команды</b>\n\n"
    "Управление задачами, базой знаний и ИИ-аналитикой — в одном рабочем пространстве.\n"
    "Два бота, одна таблица — весь бизнес под рукой прямо в этом чате.\n\n"
    "👥 <b>Глеб</b> @foxruso — контент, коммуникации, стратегия, шеф\n"
    "👩‍💻 <b>Лена</b> @elenaisanewleet — разработка, техника, продукт\n\n"
    "─────────────────────────\n"
    "🤖 <b>@PastilaTaskBot</b>\n"
    "Задачи · планирование · база знаний · ИИ-анализ · стратегия\n\n"
    "💻 <b>@pastila_code_remote_bot</b>\n"
    "Claude Code — пишет код, деплоит фичи, исследует рынок\n"
    "Запуск: Terminal → <code>cd ~/pastila_bot</code> → "
...
PIN_SECTIONS = {
    ...
    "story": (
        "📖 Зачем это всё",
        "<b>📖 Почему это меняет скорость бизнеса</b>\n\n"
        "Малый бизнес тонет не от нехватки идей — а от операционного хаоса.\n"
        "Задачи в голове, решения в переписке, дедлайны в памяти.\n"
        "Pastila OS убирает этот хаос — и высвобождает время на то, что реально приносит деньги.\n\n"
        "─────────────────────────\n"
        "<b>Что это даёт бизнесу</b>\n\n"
        "<b>💰 Больше денег — меньше упущенных возможностей.</b>\n"
        "Каждая идея, каждый лид, каждое «надо бы сделать» теперь превращается в задачу с дедлайном. "
        "Ничего не теряется в переписке. Упущенные возможности = упущенная выручка.\n\n"
        "<b>⚡ Скорость принятия решений × 10.</b>\n"
        "/strategy и /deep подключают Claude Opus с расширенным мышлением и поиском по всему интернету. "
        "Анализ конкурентов, выбор канала, приоритет задач — ответ за 2 минуты вместо дня размышлений.\n\n"
        "<b>🤖 Новая фича бота за 5 минут.</b>\n"
        "Лена пишет задачу Claude Code в терминале — через 5 минут фича уже в проде. "
        "Скорость разработки как у команды из 10 человек при команде из 2.\n\n"
        "<b>🧠 Стратег всегда под рукой.</b>\n"
        "Не нужно идти к консультанту за 50 000 руб. Один вопрос в /deep — "
        "и Opus анализирует ваши задачи, базу знаний и рынок снаружи, выдаёт конкретный план.\n\n"
        "<b>⏱ Рутина занимает в разы меньше времени.</b>\n"
        "Напоминания, статусы, дайджесты, посты — всё автоматически. "
        "Команда фокусируется на работе, а не на координации.\n\n"
        "<b>📋 Никакой потери контекста.</b>\n"
        "База знаний накапливается сама: бот замечает важное, ставит ⭐, сохраняет с тегами. "
        "Через год у вас будет энциклопедия бизнеса — вся история решений и знаний.\n\n"
        "<b>🚀 Масштабируемость без найма.</b>\n"
        "Повторяющиеся задачи → /recurring. Триггеры по словам → /remind_when. "
        "Бот берёт на себя то, на что обычно нужен отдельный человек.\n\n"
        "─────────────────────────\n"
        "<b>Стек</b>\n\n"
        "Python 3.12 · Render (всегда онлайн) · Google Sheets · "
        "30+ LLM через OpenRouter · Whisper · Notion · Claude Code\n\n"
