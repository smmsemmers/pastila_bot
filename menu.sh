...
NAV={
 ...
 "models":("🍎 Доступные модели (✓ активна в ядре). Выбери — покажу кнопки:",
   [["🍎 Opus 5",mmark("opus")],["🍎 Opus 4.7","🍎 Opus 4.6"],["🍎 Opus 3",mmark("sonnet")],
    ["🍏 Sonnet 4.6",mmark("fable")],["🍡 Haiku 4.5","⚡ Уровни (Effort)"]],"⬅️ Назад в меню","Выбери модель…"),
...
ITEMS={
 ...
 "mopus5":("🍎 Opus 5","Opus 5","🍎 Opus 5 — новейший Opus в веб-приложении claude.ai. В ядре бриджа (Claude Code) его ПОКА НЕТ — сейчас доступен Opus 4.8. Включу, как только Claude Code получит Opus 5.","⬅️ К моделям",None),
 "mopus47":("🍎 Opus 4.7","Opus 4.7","🍎 Opus 4.7 — предыдущая версия Opus. В ядре бриджа отдельно не переключается (работает Opus 4.8). Инфо для справки.","⬅️ К моделям",None),
 "mopus46":("🍎 Opus 4.6","Opus 4.6","🍎 Opus 4.6 — более ранняя версия Opus. В ядре не переключается отдельно; работает Opus 4.8.","⬅️ К моделям",None),
 "mopus3":("🍎 Opus 3","Opus 3","🍎 Opus 3 — старое поколение Opus. В ядре не используется (работает Opus 4.8).","⬅️ К моделям",None),
 "msonnet46":("🍏 Sonnet 4.6","Sonnet 4.6","🍏 Sonnet 4.6 — предыдущее поколение Sonnet. В ядре бриджа «Sonnet» = Sonnet 5; 4.6 — инфо для справки.","⬅️ К моделям",None),
