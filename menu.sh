...
screens={
 ...
 "models":{
   ...
   "ph":"Выбери модель…"},
 "bots":{
   "text":"🍫 БОЛЬШЕ БОТОВ. Нажми бота — покажу описание и кнопку «добавить в группу».",
   "kb":[[{"text":"🍎 Бридж (Claude)"},{"text":"🗂 Task-бот"}],
         [{"text":"🤖 GPT-помощник"}], BACK],
   "ph":"Выбери бота…"},
 "botbridge":{
   "text":("🍎 БРИДЖ (Claude Code) — @pastila_code_remote_bot\n\n"
     "Главный ассистент канала: разбор файлов и экспортов Claude, Notion/Drive/Gmail/Calendar, "
     "картинки, тексты, задачи, смена модели ядра. Как дать задачу — просто напиши или пришли файл."),
   "kb":[[{"text":"➕ Добавить бридж в группу"}], BACK],"ph":"⬅️ Назад в меню"},
 "bottask":{
   "text":("🗂 TASK-БОТ — @PastilaTaskBot\n\n"
     "Задачи и напоминания: /new (создать), /list (список), /digest (дайджест), /alerts (алерты). "
     "Держит общую таблицу команды, шлёт расписания."),
   "kb":[[{"text":"➕ Добавить Task в группу"}], BACK],"ph":"⬅️ Назад в меню"},
 "botgpt":{
   "text":("🤖 GPT-ПОМОЩНИК — @pastila_gPT_remote_bot\n\n"
     "Свободный чат с GPT: просто напиши вопрос или задачу. Команды: /start, /help."),
   "kb":[[{"text":"➕ Добавить GPT в группу"}], BACK],"ph":"⬅️ Назад в меню"},
 "id":{
