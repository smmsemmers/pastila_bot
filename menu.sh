...
NAV={
 "home":("☰ МЕНЮ — выбери раздел:",
   [["🍎 Доступные модели","🍫 Больше ботов"],["ℹ️ Про этот бот","🔌 Доступные плагины"],
    ["⚙️ Функции","🔗 Коннекторы"]],None,"☰ Меню…"),
...
ITEMS={
 "mopus":(mn["opus"],"Opus","🍎 Opus 4.8 — самая умная и вдумчивая. Лучше для: глубокого анализа, кода, больших разборов, стратегии. Чуть медленнее.","⬅️ К моделям",switch("opus")),
 "msonnet":(mn["sonnet"],"Sonnet","🍏 Sonnet 4.6 — быстрая и лёгкая. Лучше для: повседневных вопросов, коротких текстов, простых правок. Слабее на очень сложном.","⬅️ К моделям",switch("sonnet")),
 "mfable":(mn["fable"],"Fable","🍓 Fable 5 — тексты и креатив. Лучше для: живых художественных текстов, сторителлинга, постов. Не для кода.","⬅️ К моделям",switch("fable")),
